...
public class ComplianceRecordserviceImpl implements ComplianceRecordService {
    ...
    @Override
    public CulturalProgramResponseDto addNewProgram(CulturalProgramResponseDto dto) {
    ...
    private NewProgram mapToEntity(CulturalProgramResponseDto dto) {
